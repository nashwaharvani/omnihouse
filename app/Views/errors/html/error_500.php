        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0 rounded-4 text-center p-5">
                    ...
                    <p class="text-muted">Terjadi kesalahan pada server OMNIHOUSE. Silakan coba lagi nanti.</p>
                    <a href="/" class="btn btn-outline-danger">Kembali ke Beranda</a>
                </div>
            </div>
        </div>
    </div>
